        ...
        <section class="w3l-breadcrumb text-left">
          <div class="container">
            <ul class="breadcrumbs-custom-path">
              ...
              <li class="active">
                <span
                  class="fa fa-chevron-right mx-2"
                  aria-hidden="true"
                ></span>{" "}
                About Us
              </li>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 pl-lg-5 ">
                <div class="header-title">
                  ...
                  <h3 class="hny-title text-left">What is KIPE Vietnam?</h3>
                </div>

                <p class="mt-3">
                  Lorem ipsum dolor sit amet,Ea consequuntur illum facere
                  aperiam sequi optio consectetur adipisicing.Nunc id ipsum
                  fringilla, gravida felis vitae. lacinia id, sunt in culpa quis
                  lacinia. Lorem ipsum dolor, sit amet init elit. Eos, debitis.
                  Quas minima sunt natus tempore.
                </p>
              ...
              <div class="col-lg-6">
                ...
                <div class="skills-bars mt-4">
                  <div class="progress-info">
                    <h6 class="progress-tittle">Mathematics</h6>
                    <div class="progress">
                      <div
                  ...
                  <div class="progress-info">
                    <h6 class="progress-tittle">English</h6>
                    <div class="progress">
                      <div
                        class="progress-bar progress-bar-striped"
                        role="progressbar"
                  ...
                  <div class="progress-info">
                    <h6 class="progress-tittle">Literature</h6>
                    <div class="progress">
                      <div
                        class="progress-bar progress-bar-striped"
                        role="progressbar"
          ...
          <div class="container py-5">
            <div class="row subscription-grids py-5">
              <div class="col-lg-7 subscription-left forms-25-info">
                <div class="header-title">
                  <h3 class="p-0">This is your greatest choice</h3>
                </div>
              </div>
        ...
        <div class="team py-5">
          <div class="container py-lg-5">
            <div class="header-title mb-4">
              ...
              <h3 class="hny-title text-left">Popular Mentors</h3>
            </div>
