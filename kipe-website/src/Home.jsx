                  ...
                  <div class="banner-info">
                    <div class="container">
                      <div class="banner-info-bg">
                        ...
                        <a
                          class="btn btn-style btn-primary mt-xl-5 mt-4 mr-2"
                          href="about.html"
                        >
                          {" "}
                          Get Started{" "}
                        ...
                        <a
                          class="btn btn-style btn-white mt-xl-5 mt-4"
                          href="services.html"
                        >
                          {" "}
                          View Courses{" "}
                    ...
                    <div class="container">
                      <div class="banner-info-bg">
                        ...
                        <p class="mt-4 pr-lg-4">
                          ...
                          elit. Velit quisquam, doloremque placeat aut numquam
                          ipsam.{" "}
                        </p>
                        <a
                          class="btn btn-style btn-primary mt-xl-5 mt-4 mr-2"
            ...
            <div class="bangrids-inn">
              <div class="banhny-grid-1">
                ...
                <div class="banhny-grid-right-info">
                  <h6>
                    <a href="#url">200+ Qualified Mentors</a>
                  </h6>
                  <p>
                    Learning with mentors from top highschools/ universities in
                    the USA, Japan, Vietnam,...
                  </p>
                </div>
              </div>
              <div class="banhny-grid-1">
                ...
                <div class="banhny-grid-right-info">
                  <h6>
                    <a href="#url">1000+ Mentees Achieved Their Dreams</a>
                  </h6>
                  <p>
                    Get higher chance of acceptance from dream
              ...
              <div class="banhny-grid-1">
                ...
                <div class="banhny-grid-right-info">
                  <h6>
                    <a href="#url">100% Online</a>
                  </h6>
                  <p>Start learning right at your home!</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row content-1-grids">
            <div class="col-lg-4 content-1-left forms-25-info">
              <div class="header-title">
                ...
                <h3 class="hny-title">What is KIPE Vietnam?</h3>
              </div>
            </div>
        ...
        <div class="container py-lg-5 py-md-4">
          ...
          <div class="row top-pics ">
            <div class="col-lg-3 col-md-6 mt-5">
              <div class="top-pic1">
                <div class="card-body blog-details">
                  ...
                  <a href="services.html" class="blog-desc">
                    Business
                  </a>
                    ...
                    <ul class="blog-meta">
                      <ul class="blog-meta">
                        <li class="meta-item blog-lesson">
                          <span class="meta-value"> 40 Lessons </span>.{" "}
                    ...
                    <ul class="blog-meta">
                      <ul class="blog-meta">
                        <li class="meta-item blog-lesson">
                          ...
                          <span class="meta-value text-bold">$49.00</span>
                        </li>
                      </ul>
                    </ul>
                  </div>
                  ...
                  <div class="author align-items-center">
                    ...
                    <ul class="blog-meta">
                      <ul class="blog-meta">
                        <li class="meta-item blog-lesson">
                          <span class="meta-value"> 30 Lessons </span>.{" "}
                          <span class="meta-value text-bold">$59.00</span>
                        </li>
                      </ul>
                    </ul>
                  </div>
            ...
            <div class="readhny-btm text-center mx-auto mt-md-4">
              <a
                class="btn btn-primary btn-style mt-md-5 mt-4"
                href="about.html"
              >
                Read More{" "}
                <span
                  ...
                  <div class="col-sm-10 area-box-info">
                    <h4>
                      <a href="#feature" class="title-head">
                        Become a mentor at KIPE Vietnam
                      </a>
                    </h4>
                    <p class="mt-3">
                    ...
                    <a class="btn btn-primary btn-style mt-4" href="about.html">
                      Start today{" "}
                      <span
                        class="fa fa-chevron-right ml-2"
                        aria-hidden="true"
              ...
              <div class="area-box">
                <div class="row">
                  ...
                  <div class="col-sm-10 area-box-info">
                    <h4>
                      <a href="#feature" class="title-head">
                        KIPE Vietnam for Business & Community
                      </a>
                    </h4>
                    <p class="mt-3">
                      Lorem ipsum viverra feugiat. Pellen tesque libero ut
      ...
      <div class="middle py-5">
        <div class="container pt-lg-2 pb-lg-4 py-4">
          <div class="welcome-left text-center py-lg-4">
            <h3 class="hny-title">
              To lonely sailors, Let's together conquer the enternal sea
            </h3>
            ...
            <div class="row">
              <div class="col-md-3 col-6 mt-md-0 mt-5">
                <div class="counter">
                  ...
                  <div
                    class="timer count-title count-number mt-3"
                    data-to="720"
                    data-speed="1500"
                  ></div>
                  <p class="count-text">Active Days</p>
                </div>
              </div>
              <div class="col-md-3 col-6 mt-md-0 mt-5">
                <div class="counter">
                  ...
                  <div
                    ...
                    data-speed="1500"
                  ></div>
                  <p class="count-text ">Applications Received</p>
                </div>
              </div>
              <div class="col-md-3 col-6 mt-md-0 mt-5">
                <div class="counter">
                  ...
                  <div
                    ...
                    data-speed="1500"
                  ></div>
                  <p class="count-text">Total Followers On Social Media</p>
                </div>
              </div>
              <div class="col-md-3 col-6 mt-md-0 mt-5">
                <div class="counter">
                  ...
                  <div
                    ...
                    data-speed="1500"
                  ></div>
                  <p class="count-text">Charged Cost</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="w3l-videohny" id="video">
        <div class="new-block py-5">
          <div class="container py-lg-5">
            ...
            <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
              <iframe
                src="https://player.vimeo.com/video/18212142"
                frameborder="0"
                ...
                <div class="card-body blog-details">
                  ...
                  <div class="author align-items-center">
                    ...
                    <ul class="blog-meta">
                      ...
                      <li class="meta-item blog-lesson">
                        <span class="meta-value"> Sep 13, 2020 </span>.{" "}
