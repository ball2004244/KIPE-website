              ...
              <div class="cont-details">
                <div class="contactct-fm-text text-left mb-md-5 mb-4">
                  ...
                  <p class="mb-sm-5 mb-4">
                    Start working with Us that can provide everything you need
                    to generate awareness, drive traffic, connect. <br /> We
                    guarantee that you’ll be able to have any issue resolved
                    within 24 hours.
                  </p>
                </div>
                <div class="cont-top">
                  ...
                  <div class="cont-right">
                    <h6>Phone number</h6>
                    <p>
                      <a href="tel:(+84) 942 406 277">(+84) 942 406 277</a>
                    </p>
                  </div>
                </div>
                <div class="cont-top margin-up">
                  ...
                  <div class="cont-right">
                    <h6>Send Email</h6>
                    <p>
                      <a href="mailto:general@kipevietnam.com" class="mail">
                        general@kipevietnam.com
                      </a>
                    </p>
                  </div>
                </div>
                <div class="cont-top margin-up">
                  ...
                  <div class="cont-right">
                    ...
                    <p class="pr-lg-5">Ho Chi Minh City, Vietnam</p>
                  </div>
                </div>
              </div>
